...
def check_type_and_create_list_of_books(
    ...
    if params_to_search in title:
        ...
        list_of_books = add_books_to_dictionary(mode_of_sort='inauthor', keywords=authors)
    elif params_to_search in publisher:
        list_of_books = add_books_to_dictionary(mode_of_sort='inpublisher', keywords=publisher)
    elif params_to_search in subject:
        list_of_books = add_books_to_dictionary(mode_of_sort='subject', keywords=subject)
    elif params_to_search in isbn:
        list_of_books = add_books_to_dictionary(mode_of_sort='isbn', keywords=isbn)
    elif params_to_search in lccn:
        list_of_books = add_books_to_dictionary(mode_of_sort='lccn', keywords=lccn)
    elif params_to_search in oclc:
        list_of_books = add_books_to_dictionary(mode_of_sort='oclc', keywords=oclc)
    else:
        return None
